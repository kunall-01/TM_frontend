...
const StatCard = ({ label, value, accent }) => (
  <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5">
    <p className="text-xs text-zinc-500 mono mb-2 uppercase tracking-wider">
      {label}
    </p>
...
export default function Dashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div>
        <p className="mono text-xs text-zinc-500 mb-4 uppercase tracking-wider">
          Recent Tasks
        </p>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <span
                      className={`text-sm truncate ${isOverdue ? "text-red-400" : "text-zinc-200"}`}
                    >
                      {task.title}
                    </span>
                    {isOverdue && (
